  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl mb-8 underline underline-offset-8 decoration-primaryDark">Make a formal complaint without a lawyer</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <Card className="p-6 border-none">
            <h2 className="text-2xl mb-4 underline underline-offset-8 decoration-primaryDark">Things to know before you get started:</h2>
          ...
          <Card className="p-6 border-none">
            <h2 className="text-2xl mb-4 underline underline-offset-8 decoration-primaryDark">Here's how the tool works:</h2>
