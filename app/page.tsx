      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <Card className="p-6 border-none">
            <h2 className="text-2xl font-semibold mb-4 underline underline-offset-8 decoration-primaryDark">Things to know before you get started:</h2>
          ...
          <Card className="p-6 border-none">
            <h2 className="text-2xl font-semibold mb-4 underline underline-offset-8 decoration-primaryDark">Here's how the tool works:</h2>
